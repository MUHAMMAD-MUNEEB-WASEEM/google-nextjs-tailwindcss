...
export default function Home() {
  return (
    <div>
      ...
      {/*Body*/ }
      <form className="flex flex-col items-center justify-center content-center ">
        <Image 
        loading="lazy"
        ...
        <div className="flex w-full items-center mt-5 hover:shadow-lg focus-within:shadow-lg 
